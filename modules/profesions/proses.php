...
require_once "../../config/database.php";
	...
	if ($_GET['act']=='insert') {
		if (isset($_POST['Guardar'])) {
			...
			$area = mysqli_real_escape_string($mysqli, trim($_POST['especialidad']));
			$telefono = mysqli_real_escape_string($mysqli, trim($_POST['telefono']));
			$horario = mysqli_real_escape_string($mysqli, trim($_POST['horario_consulta']));
			$precios = mysqli_real_escape_string($mysqli, trim($_POST['precios_consulta']));


            $query = mysqli_query($mysqli, "INSERT INTO profesionistas(nombre,apellidos,id_area,telefono,horario_consulta,precios_consulta)
                                            VALUES('$nombre','$apellidos','$area','$telefono','$horario','$precios')")
