...
<html>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div class="login-logo bg-azul">
        <img style="margin-top:-12px" src="assets/img/logo-blue.png" alt="Logo" height="50"> <b>Talkhealth</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      elseif ($_GET['alert'] == 1) {
        echo "<div class='alert alert-danger alert-dismissable'>
                ...
                <h4>  <i class='icon fa fa-times-circle'></i> Error de acceso!</h4>
